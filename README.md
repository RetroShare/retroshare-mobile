...
* Add the Android  dependencies `Android x86` , `Android ARM64-v8a` and `Android ARMv7` using QT   maintainer 
* Added the `Qt 5.12.5` location in `retroshare-service.properties.example` file in qt.installdir.
```bash
cd android
