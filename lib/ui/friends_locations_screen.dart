              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    Expanded(
      child: 
                      FutureBuilder(future: _getFriendsAccounts() ,builder: (context, snapshot) {
                                        ...
                                        itemBuilder:
                                          ...
                                          return PersonDelegate(
                                            data: PersonDelegateData(
                                              name: idsTuple.friendlist[index]
                                                      .accountName +
                                                  ':' +
                                              ...
                                              message: idsTuple
                                                  ...
                                                  ':' +
                                                  idsTuple
                                                      .friendlist[index].rsPeerId,
                                              isOnline: idsTuple
                                                  .friendlist[index].isOnline,
                                              isMessage: true,
                                            ),
                                          );
                                        },
                              ...
                              child: Shimmer(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (_, __) => Container(
                                          ...
                                          decoration: BoxDecoration(border: Border.all(color: Colors.white),borderRadius: BorderRadius.circular(14)),
                                          child: Row(
                                              crossAxisAlignment:
