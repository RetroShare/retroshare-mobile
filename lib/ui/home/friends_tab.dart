          ...
          return Consumer<RoomChatLobby>(
            builder: (context, roomChat, _) {
              ...
              return Stack(
                children: <Widget>[
                  Visibility(
                    visible: friendsDistantAndIdsTuple.item1?.isNotEmpty ??
                      ...
                      slivers: <Widget>[
                        ...
                        SliverPadding(
                          padding: EdgeInsets.only(
                              ...
                              right: 16,
                              bottom:
                                  (friendsDistantAndIdsTuple.item2?.isEmpty ??
                                          true)
                          ...
                          sliver: SliverFixedExtentList(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              ...
                              childCount:
                                  friendsDistantAndIdsTuple.item1?.length,
                            ),
                          ),
                        ),
                        SliverOpacity(
                          opacity:
                              (friendsDistantAndIdsTuple.item2?.isNotEmpty ??
                                          false) &&
                                      (friendsDistantAndIdsTuple.item2?.length >
                                              0 ??
                                          false)
                                  ? 1.0
                                  : 0.0,
                  ...
                  Visibility(
                    visible: friendsDistantAndIdsTuple.item1?.isEmpty ??
                        true && friendsDistantAndIdsTuple.item2?.isEmpty ??
                        true,
                    child: Center(
                      child: SizedBox(
                        width: 200,
